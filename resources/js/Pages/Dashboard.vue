<template>
    ...
    <Layout divClass="px-6">
        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
            ...
            <div class="bg-white shadow rounded-lg mb-4 h-full flex-1">
                <div class="mt-2 p-4 sm:p-6 border-gray-200">
                    <h3 class="text-xl font-bold leading-none text-gray-900 mb-2">Valor total a receber: {{
                        formatCurrency(totalOutstandingBalance) }}</h3>
        ...
        <div class="mt-4 w-full grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
            ...
            <Link href="/orders?status=Entrega%20Agendada">
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 hover:bg-gray-100">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{
                            orders_by_status['Entrega Agendada'] }}</span>
            ...
            <Link href="/orders?status=Entrega%20Não%20Agendada">
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 hover:bg-gray-100">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{
                            orders_by_status['Entrega Não Agendada'] }}</span>
...
let props = defineProps({
    ...
    sales_percentage_increase: [String, Number],
    profit_percentage_increase: [String, Number],
    completed_orders_percentage_increase: [String, Number],
});
