        ...
        <div class="modal-content bg-white rounded shadow-lg w-11/12 md:w-1/3">
          <div class="border-b border-gray-200 p-4 flex justify-between">
            <div class="flex items-start space-x-3">
              <i class="fa-solid fa-bag-shopping border border-gray-200 p-3 shadow-sm rounded-md" />
              <div>
          ...
          <form @submit.prevent="saveOrderProducts">
            <div class="p-4">
              <label
                for="products"
                class="text-sm font-bold leading-6 text-gray-800 hidden"
              >Produtos</label>
              ...
              >
                <ProductSelect
                  :products="availableProducts" :model-value="product"
                  class="flex-1" @update:model-value="updateProduct(index, $event)"
                />
                <input
                ...
                />
                <button type="button" class="ml-2 text-red-500 text-sm" @click="removeProduct(index)">
                  Remover
                </button>
              </div>
