<template>
    <div class="mt-4 md:mt-6 flex flex-col w-full bg-white p-3 mb-6" v-if="sortedHistories.length">
        ...
        <div class="flex flex-col space-y-2 mt-3">
            <div v-for="history in sortedHistories" :key="history.id" class="bg-gray-100 p-2 rounded">
