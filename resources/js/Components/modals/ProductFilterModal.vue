                ...
                <div class="modal-content bg-white rounded shadow-lg w-11/12 md:w-1/3">
                    ...
                    <form @submit.prevent="saveFilters()">
                        ...
                        <div class="p-4">
                            ...
                            <!-- Descrição -->
                            <InputField label="Descrição" aditionalLabel="(busque por uma palavra)" id="description"
                                v-model="formFilters.description" wrapperClass="mt-0" />

                            <!-- Data de Criação -->
                            <label for="start_date"
                                class="block text-sm font-medium leading-6 text-gray-900 mt-4">Período
                                de Data de
                                Criação</label>
