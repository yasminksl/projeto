        ...
        <div class="modal-content bg-white rounded shadow-lg">
          ...
          <div class="border-b border-gray-200 p-4 flex justify-between">
            <div class="flex items-start space-x-3">
              <i class="fa-solid fa-image border border-gray-200 p-3 shadow-sm rounded-md" />
              <div>
          ...
          <form @submit.prevent="submit">
            <div class="p-4">
              ...
              <div class="space-y-3 mt-5">
                <div
                  class="flex items-center space-x-2 border border-gray-200 rounded p-2 bg-gray-100 hover:bg-gray-300 cursor-pointer"
...
const closeModal = () => {
    ...
    imageUrl.value = props.profilePhotoUrl
}

const toast = useToast()

const imageUrl = ref(props.profilePhotoUrl)
